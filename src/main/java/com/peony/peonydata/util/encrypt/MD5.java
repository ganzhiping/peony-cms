package com.peony.peonydata.util.encrypt;
...
public class MD5 {
	...
	public static String passwordEncrypt(String str) {
		return MD5
				.Encrypt2(str, MD5.toMD5(PASSWORD_ENCRYPT_PASSWORD));
	}
	...
	public static String passwordDecrypt(String encrypt) {
		return MD5.Decrypt2(encrypt, MD5
				.toMD5(PASSWORD_ENCRYPT_PASSWORD));
	}

	
	public static void main(String[] args) {
		System.out.print(passwordEncrypt("121"));
