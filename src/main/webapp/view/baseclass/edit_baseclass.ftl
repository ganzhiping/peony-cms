...
<script src="${request.getContextPath()}/js/baseclass/baseclass_edit.js"></script>
...
<div class="tneirong_2_in">
        <div class="table_tanchu">
       	<form id="editForm">
			...
			<input type="hidden" name="baseclassId" value="${baseClass.baseclassId}"/>
			<input type="hidden" name="baseclassPid" id="pid" value="${baseClass.baseclassPid}"/>
	          <table border="0" cellspacing="0" cellpadding="0">
	            <tr>
	               <th align="right">所属基础类型：</th>
	           	   <td> <input type="text" name="pname"  id="citySel" value="" onclick="showMenu()"  readonly/></td>
	            </tr>
	            <tr>
	              <th><span class="F00">*</span>基础类别名称：</th>
	              <td><input  type="text" name="name" value="${baseClass.name}" datatype="*" nullmsg="请填写类别名称" /></td>
	            </tr>
	            <tr>
	              <th><span class="F00">*</span>排序：</th>
	              <td><input  type="text" value="${baseClass.order}" name="order"  datatype="n" nullmsg="请填写排序号"/></td>
	            </tr>
	            <tr>
	              <th><span class="F00">*</span>是否为公共词库：</th>
	              <td><input  type="radio" value="1" name="isPublic"  <#if baseClass.isPublic==1> checked</#if>/>是   &nbsp; &nbsp; <input  type="radio" value="0" name="isPublic" <#if baseClass.isPublic==0> checked</#if> />否</td>
	            </tr>
	            <tr>
