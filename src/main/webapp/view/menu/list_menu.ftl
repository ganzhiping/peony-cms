...
<body class="baody2" style="background:#FFFFFF">
...
<ul class="tree_ul ztree" id="menuTree" style="width:175px;"></ul></td>
</div>
   <div style="float:left;margin-left:30px;" >
   <iframe width="420" height="400" frameborder="0" id="viewframe" scrolling="auto" src=""></iframe>
  </div>
  </div>
...
<script src="${request.getContextPath()}/js/menu/menu.js"></script>
...
$(function() {
	...
	$.fn.zTree.init($("#menuTree"), configTree(),${nodeList});
});
	</SCRIPT>
</body>
</html>
