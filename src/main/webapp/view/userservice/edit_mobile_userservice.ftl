...
<script src="${request.getContextPath()}/js/userservice/usermobileservice.js"></script>
...
<table border="0" cellspacing="0" cellpadding="0">
 ...
 <!-- <tr>
  ...
  <tr>
    <th>截止日期：</th>
    <td>
      <input type="text" name="deadline" id="deadline" value="${userService.deadline}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  /> </td>
  </tr>
   <tr>
    <th>用户类型：</th>
    <td>
	    <#if userService.platformType?if_exists>
	        <input type="radio" name="platformType" value="1"  checked  />正式  <input type="radio" name="platformType" value="2" <#if  userService.platformType=='2'> checked</#if> />试用  <input type="radio" name="platformType" value="3" <#if  userService.platformType=='3'> checked</#if> />未注册
	    <#else>
	        <input type="radio" name="platformType" value="1" />正式  <input type="radio" name="platformType" value="2" />试用  <input type="radio" name="platformType" value="3"  checked/>未注册
	    </#if>
    </td>
  </tr>
  <tr>
    ...
    <td>
	    ...
	    <#else>
	        <input type="radio" name="status" value="1"/>有效<input type="radio" name="status" value="3" checked/>无效
	    </#if>
    </td>
  </tr>
  <tr>
  ...
  <td>
    <#if userService.reportCreate?if_exists>
        <input type="radio"  value="1"    />是 <input type="radio"  value="0"  />否&nbsp;&nbsp;&nbsp;&nbsp;(暂无此功能)
    	  <!--<input type="radio" name="reportCreate" value="1"  checked  />是 <input type="radio" name="reportCreate" value="0" <#if  userService.reportCreate=='0'> checked</#if> />否&nbsp;&nbsp;&nbsp;&nbsp;(暂无此功能)-->
    </#if>
 </td>
  </tr>
  <tr>
  ...
  <td>
    <#if userService.reportSend?if_exists>
        <input type="radio"  value="1" />是 <input type="radio"  value="0" />否&nbsp;&nbsp;&nbsp;&nbsp;(暂无此功能)
        <!--<input type="radio" name="reportSend" value="1"  checked  />是 <input type="radio" name="reportSend" value="0" <#if  userService.reportSend=='0'> checked</#if> />否&nbsp;&nbsp;&nbsp;&nbsp;(暂无此功能)-->
    </#if>
 </td>
  </tr>
 <tr>
  ...
  <td>
    <#if userService.warningSend?if_exists>
        <input type="radio" name="warningSend" value="1"  <#if  userService.warningSend=='1'> checked</#if>  />是 <input type="radio" name="warningSend" value="0" <#if  userService.warningSend=='0'> checked</#if> />否
    </#if>
 </td>
  </tr>
  <tr>
