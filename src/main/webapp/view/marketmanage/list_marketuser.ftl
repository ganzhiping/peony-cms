...
<div class="tb mianbaoxue">首页 &gt;&gt; 用户管理 &gt;&gt; 市场用户管理</div>
<input type="hidden" id="pageContext" value="${request.getContextPath()}"/>
<div class="sousuox">
<dl>
	<dt>用 户 名：</dt><dd><input class="input_text input_text3" type="text" id="loginName" name="loginName"  /></dd>
	<dt>姓 名：</dt><dd><input class="input_text input_text3" type="text"  id="name" name="name"  /></dd>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="display lis_tablet4"  id="list_info" >
		...
		<script src="${request.getContextPath()}/js/marketmanage/marketmanage.js"></script>
</body>
</html>
