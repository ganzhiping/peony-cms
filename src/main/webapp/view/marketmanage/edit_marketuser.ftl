...
<script type="text/javascript" language="javascript" src="${request.getContextPath()}/js/marketmanage/marketuser_edit.js"></script>
        ...
        <div class="table_tanchu">
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td colspan="3"><input class="input_text" type="text"  readOnly name="loginName" value="${user.loginName}"  id="loginName" class="cword gray" /> </td>
            </tr>
            <tr>
              <th><span class="F00">*</span>姓名：</th>
              <td><input class="input_text input_text_small" type="text" name="name" value="${user.name}" id="name"  class="cword gray" datatype="*" nullmsg="请填写姓名"/><span id="fieldErr_userName"></span></td>
              <th>性别：</th>
            ...
            <tr>
              ...
              <td><input type="password" name="password" value="${user.password}" id="password"  class="cword gray" datatype="*" nullmsg="请填写密码"/><span id="fieldErr_password"></span></td>
              <th><span class="F00">*</span>确认密码：</th>
              <td><input type="password" name="confirmpassword" value="${user.password}" id="confirmpassword"  class="cword gray" datatype="*" nullmsg="请重复填写密码" recheck="password" errormsg="您两次输入的密码不一致！"/><span id="fieldErr_confirmpwd"></span></td>
            </tr>
            <tr>
              <th>邮箱：</th>
              <td colspan="3"><input class="input_text input_mail" type="text" name="email" value="${user.email}" id="email"  datatype="e"/></td>
            </tr>
              <tr>
              <th>qq：</th>
              <td colspan="3"><input class="input_text input_mail" type="text"   name="qq" value="${user.qq}" /></td>
            </tr>
            <tr>
              <th>手机：</th>
