...
<div class="tb mianbaoxue">首页 &gt;&gt; 系统配置 &gt;&gt; 代理商管理(移动免费版)</div>
<div class="sousuox">
<dl>
	<dt>单位名称：</dt>
	<dd>
...
<dl>
	...
	<dd>
     ...
     <dt>录入时间：</dt>
	  <dd>
			<input class="input_text input_text3" type="text" id="beginCreateTime" name="beginCreateTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  />
	  </dd>
	   <dt>至：</dt>
	  <dd>
			<input class="input_text input_text3" type="text" id="endCreateTime" name="endCreateTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
		...
		<input type="button" class="tb baocunanniu color_bai" onClick="toAdd();" value="添加"/>
		...
		<script src="${request.getContextPath()}/js/agent/all_mobile_agent.js"></script>
</body>
</html>
