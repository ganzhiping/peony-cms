 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="text" name="phone" datatype="/(^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?$)|(^((\(\d{3}\))|(\d{3}\-))?(1[358]\d{9})$)/" value="${agent.phone}"  class="input_text"/>
     </td>
  </tr>
  <!--<tr>
  ...
  <tr>
    <th>设备型号：</th>
    <td><input type="text" name="model" value="${agent.model}"  class="input_text"/></td>
  </tr>
   <tr>
    <th></th>
