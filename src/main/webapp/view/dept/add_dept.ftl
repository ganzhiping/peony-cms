...
<script src="${request.getContextPath()}/js/dept/dept_add.js"></script>
...
<form id="addForm" >
	...
	<input type="hidden" name="deptPid" id="pid" />
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="boxTable boxmar">
    
        <tr class="bg nobr">
            <td align="right">所属部门：</td>
            <td> <input type="text" name="pname"  id="citySel" value="" onclick="showMenu()" class="cword gray" datatype="*" nullmsg="请填写父部门名称" readonly/><span id="fieldErr_fatherName"></span></td>
	          
            </td>
        </tr>
        <tr class="nobg">
            <td align="right"><span class="F00">*</span>部门名称：</td>
            <td><input type="text" name="name" value="" class="cword gray" datatype="*" nullmsg="请填写部门名称"/><span id="fieldErr_departmentName"></span></td>
        </tr>
        <tr class="nobg">
        ...
        <tr class="nobg">
            ...
            <td><input type="text" name="head" value="" class="cword gray"/></td>
        </tr>
        <tr class="nobg">
            <td align="right"><span class="F00"></span>部门描述：</td>
            <td><input type="text" name="address" value="" class="cword gray"/></td>
        </tr>
