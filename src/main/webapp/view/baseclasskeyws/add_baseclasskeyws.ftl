...
<script src="${request.getContextPath()}/js/baseclasskeyws/baseclasskeyws_add.js"></script>
...
<body style="background:#FFFFFF">
	<input type="hidden" id="pageContext" value="${request.getContextPath()}"/>
      <div class="tneirong_2_in">
        ...
        <form  id="baseclassAddform" >
        <input type="hidden" name="baseclassId" value="${baseclassId}"/>
          <table border="0" cellspacing="0" cellpadding="0">
           <tr>
            <td><span class="F00">*</span>名称：</th>
            <td><input  type="text" name="name" value="" datatype="*" nullmsg="请填写名称" /></td>
	       </tr>
           <tr>
              <th><span class="F00">*</span>关键字：</th>
              <td>
              	<textarea name="content" rows="6" cols="50" datatype="*" nullmsg="请填写关键字"></textarea><span id="fieldErr_departmentName"></span>
              </td>
            </tr>
            <tr>
              <th valign="top">&nbsp;</th>
