...
<div style="float:left;">
	<ul class="tree_ul ztree" id="baseClassTree" style="width:175px;"></ul></td>
</div>
  <div style="float:left;margin-left:30px;" class="nobg">
   <iframe width="750" height="465" frameborder="0" id="viewframe" scrolling="auto" src=""></iframe>
  </div>
</div>
...
<script src="${request.getContextPath()}/js/baseclasskeyws/baseclass.js"></script>
...
$(function() {
	...
	$.fn.zTree.init($("#baseClassTree"), configTree(),${nodeList});
});
	</SCRIPT>
</body>
</html>
