...
<script src="${request.getContextPath()}/js/popular/popular_add.js"></script>
<!-- 添加kindeditor的引用 -->
<script>
...
<div class="tneirong_2_in">
    <div class="table_tanchu">
        <form  id="popularAddform" enctype="multipart/form-data">
            <table border="0" cellspacing="0" cellpadding="0" id="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="writer" value="" class="cword gray"datatype="*" nullmsg="请填写关键字" />
                    </td>
                </tr>
                <tr>
                    <th>期数：</th>
                    <td>
                        <input type="text" name="periods" value="" class="cword gray"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="userName" value="" id="s_f_btn_1" class="cword gray" datatype="*" nullmsg="请填写关键字"/>
                    </td>
                </tr>
                <tr>
                    <th><span class="F00">*</span>出处：</th>
                    <td>
                        <textarea  name="descript" style="width:850px;height:100px;" datatype="*1-500" nullmsg="摘要不能为空" errormsg="摘要不能超过500字"></textarea>
                    </td>
                </tr>
                <tr>
