...
<script src="${request.getContextPath()}/js/combo/add_combo.js"></script>
        ...
        <form id="addForm">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><input type="text" name="name" value="" class="input_text" datatype="*" nullmsg="请填写套餐名称"/></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>关键词数量：</th>
              <td><input type="text" name="keywordnumber" value="" class="input_text" datatype="n1-11" nullmsg="请填写关键词数量" errormsg="关键词个数为数字"/></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>话题数量：</th>
              <td><input type="text" name="topicnumber" value="" class="input_text" datatype="n1-11" nullmsg="请填写话题数量" errormsg="话题个数为数字"/></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>说明：</th>
              <td><textarea name="introduce" rows="2" cols="34"  datatype="s1-400" nullmsg="请填写说明" errormsg="最多400个字符"></textarea></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>单价：</th>
              <td><input type="text" name="price"  class="input_text" datatype="/([0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*)([eE][+-]?[0-9]+)?$/" nullmsg="请填写单价" errormsg="单价应为数值"/></td>
            </tr>
            <tr>
              <th valign="top">&nbsp;</th>
              <td valign="top">
