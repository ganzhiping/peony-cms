...
<div class="tb mianbaoxue">首页 &gt;&gt; E人E本 &gt;&gt; 套餐管理</div>
<div class="tianjia">
<div class="tb baocunanniu color_bai" id="create">添 加</div>
</div>
<input type="hidden" id="pageContext" value="${request.getContextPath()}"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="display lis_tablet4"  id="list_combo" >
			<thead>
...
<script src="${request.getContextPath()}/js/combo/combo.js"></script>
