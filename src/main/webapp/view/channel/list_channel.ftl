...
<body class="baody2">
<div class="tb mianbaoxue">首页 &gt;&gt; 信息管理 &gt;&gt; 案例目录</div>
...
<ul class="tree_ul ztree" id="channelTree" style="width:175px;"></ul></td>
</div>
   <div style="float:left;">
   <iframe width="420" height="330" style="margin-left:30px;" frameborder="0" id="viewframe" scrolling="auto" src=""></iframe>
  </div>
</div>
		...
		<script src="${request.getContextPath()}/js/channel/channel.js"></script>
