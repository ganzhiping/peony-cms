...
<script src="${request.getContextPath()}/js/channel/channel_add.js"></script>
...
<body style="background:#FFFFFF">
 <div class="tneirong_2_in">
        ...
        <form id="channelAddForm" >
			...
			<input type="hidden" name="channelPid" id="pid" />
	          <table border="0" cellspacing="0" cellpadding="0">
	            ...
	            <tr>
	              ...
	              <td><input  type="text" value="" name="orderno"  datatype="n" nullmsg="请填写排序号"/></td>
	            </tr>
	            <tr>
