...
<script src="${request.getContextPath()}/js/channel/channel_edit.js"></script>
...
<body style="background:#FFFFFF">
 <div class="tneirong_2_in">
        ...
        <form id="editForm" >
			...
			<input type="hidden" name="channelPid" id="pid" value="${channel.channelPid}"/>
	          <table border="0" cellspacing="0" cellpadding="0">
	            ...
	            <tr>
	              ...
	              <td><input  type="text" name="name" value="${channel.name}" datatype="*" nullmsg="请填写类别名称" /></td>
	            </tr>
	            <tr>
	              <th><span class="F00">*</span>排序：</th>
	              <td><input  type="text" value="${channel.orderno}" name="orderno"  datatype="n" nullmsg="请填写排序号"/></td>
	            </tr>
	            <tr>
