...
<script src="${request.getContextPath()}/js/pointsexchange/add_pointsexchange.js"></script>
        ...
        <form id="addForm">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><input type="text" name="points" value="" class="input_text" datatype="/([0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*)([eE][+-]?[0-9]+)?$/" nullmsg="请填写积分" errormsg="积分应为数值"/></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>积分单价：</th>
              <td><input type="text" name="unitprice" value="" class="input_text" datatype="/([0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*)([eE][+-]?[0-9]+)?$/" nullmsg="请填写积分单价" errormsg="积分单价应为数值"/></td>
            </tr>
            <tr>
              <th valign="top">&nbsp;</th>
              <td valign="top">
