...
<script src="${request.getContextPath()}/js/discount/edit_discount.js"></script>
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><select name="comboid" id="comboid" >
    					...
    					<option value="${combo.id}" <#if combo.id=discount.comboid>selected="selected"</#if>>${combo.name}</option>
   						</#list>
					</select>
			  </td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="beginday" value="${discount.beginday}" class="input_text" datatype="n1-11" nullmsg="请填写开始天数" errormsg="开始天数为数字"/></td>
            </tr>
            <tr>
              <th><span class="F00">*</span>结束天数：</th>
              <td><input type="text" name="endday" value="${discount.endday}" class="input_text" datatype="n1-11" nullmsg="请填写结束天数" errormsg="结束天数为数字"/></td>
            </tr>
            
            <tr>
              <th><span class="F00">*</span>折扣：</th>
              <td><input type="text" name="discount" value="${discountPrice}" class="input_text" datatype="/([0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*)([eE][+-]?[0-9]+)?$/" nullmsg="请填写折扣价格" errormsg="折扣价应为数值"/></td>
            </tr>
            <tr>
              <th valign="top">&nbsp;</th>
              <td valign="top">
              <div class="aniu_xinxi_fab">
                  ...
                  <input class="tb fabiao1 color_bai" type="button" id="subBtn" value="修改" />
                </div></td>
            </tr>
          </table>
          </form>
