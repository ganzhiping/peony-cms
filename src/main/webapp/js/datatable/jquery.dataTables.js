	...
	var DataTable = function( oInit )
	{
		...
		function _fnLanguageCompat( oLanguage )
		{
			...
			if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
				oDefaults.sEmptyTable === "对不起，没有找到相关数据信息！" )
			{
		...
		function _fnFeatureHtmlProcessing ( oSettings )
		{
			...
			nProcessing.innerHTML = "数据加载中...";//oSettings.oLanguage.sProcessing;
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					'<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'" title="'+oLang.sFirst+'"></a>'+
					'<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'" title="'+oLang.sPrevious+'"></a>'+
					'<span></span>'+
					'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'" title="'+oLang.sNext+' "></a>'+
					'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'" title="'+oLang.sLast+' "></a>'
				);
				var els = $('a', nPaging);
				var nFirst = els[0],
					nPrev = els[1],
